...
### Cloud using VM
* host your application into **cloud** (use AWS, Google or anyother VM, you can use docker-compose for hosting on VM), on vm u would need docker, docker-compose, git installed, then u can clone the repository and simply run docker-compose up, the way you do it on local
* Once deployed share the URL for your application
